...
# ---------------------------------------------------------------------------
# Declarative world spec models (mirrors world.yaml structure)
# ---------------------------------------------------------------------------


class WorldMeta(BaseModel):
    """Top-level metadata block from a world.yaml file."""
...
class TransitionSpec(BaseModel):
    """A transition declaration as written in world.yaml."""
...
class ConstraintSpec(BaseModel):
    """A constraint declaration as written in world.yaml."""
...
class WorldSpec(BaseModel):
    """JSON-serializable representation of a declarative world.yaml file."""

    world: Optional[WorldMeta] = None
